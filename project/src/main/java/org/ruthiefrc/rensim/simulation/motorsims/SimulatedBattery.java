package org.ruthiefrc.rensim.simulation.motorsims;
...
public class SimulatedBattery {
     ...
     */
    public static void addMotor(RenMotorSim mapleMotorSim) {
    ...
    public static void simulationSubTick() {
        ...
        if (Double.isNaN(batteryVoltageVolts)) {
            ...
            DriverStation.reportError(
                    "[RenSim] Internal Library Error: Calculated battery voltage is invalid"
        ...
        if (batteryVoltageVolts < RoboRioSim.getBrownoutVoltage()) {
            ...
            DriverStation.reportError("[RenSim] BrownOut Detected, protecting battery voltage...", false);
        }
