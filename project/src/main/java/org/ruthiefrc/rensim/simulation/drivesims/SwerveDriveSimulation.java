 ...
 *       {@link SwerveModuleSimulation#updateSimulationSubTickGetModuleForce(Vec2, Rotation2d, double)}.
...
public class SwerveDriveSimulation extends AbstractDriveTrainSimulation {
    ...
    private void simulateChassisFrictionForce() {
        ...
        final Vec2 speedsDifferenceFrictionForce = Vec2.create(
                Math.min(
                        FRICTION_FORCE_GAIN * totalGrippingForce * floorAndModuleSpeedsDiffFieldRelative.getNorm(),
                        totalGrippingForce),
                RenCommonMath.getAngle(floorAndModuleSpeedsDiffFieldRelative).getRadians());
        ...
        final Rotation2d dTheta = RenCommonMath.getAngle(
                        GeometryConvertor.getChassisSpeedsTranslationalComponent(moduleSpeedsFieldRelative))
                .minus(RenCommonMath.getAngle(previousModuleSpeedsFieldRelative));
        ...
        final Rotation2d centripetalForceDirection =
                RenCommonMath.getAngle(previousModuleSpeedsFieldRelative).plus(Rotation2d.fromDegrees(90));
        final Vec2 centripetalFrictionForce = Vec2.create(
     ...
     * @see org.ruthiefrc.rensim.simulation.drivesims.configs.SwerveModuleSimulationConfig#maximumGroundSpeed()
     */
     ...
     * @see org.ruthiefrc.rensim.simulation.drivesims.configs.SwerveModuleSimulationConfig#maxAcceleration(Mass, int, Current)
     */
