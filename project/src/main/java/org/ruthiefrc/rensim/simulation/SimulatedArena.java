package org.ruthiefrc.rensim.simulation;
...
import org.ruthiefrc.rensim.simulation.drivesims.AbstractDriveTrainSimulation;
import org.ruthiefrc.rensim.simulation.gamepieces.GamePiece;
import org.ruthiefrc.rensim.simulation.gamepieces.GamePieceOnFieldSimulation;
import org.ruthiefrc.rensim.simulation.gamepieces.GamePieceProjectile;
import org.ruthiefrc.rensim.simulation.motorsims.SimulatedBattery;
import org.ruthiefrc.rensim.simulation.seasonspecific.rebuilt2026.Arena2026Rebuilt;
import org.ruthiefrc.rensim.utils.mathutils.GeometryConvertor;
...
public abstract class SimulatedArena {
    ...
    public NetworkTable redTable =
            NetworkTableInstance.getDefault().getTable("SmartDashboard/RenSim/MatchData/Breakdown/Red Alliance");
    public NetworkTable blueTable =
            NetworkTableInstance.getDefault().getTable("SmartDashboard/RenSim/MatchData/Breakdown/blue Alliance");
    public NetworkTable genericInfoTable =
            NetworkTableInstance.getDefault().getTable("SmartDashboard/RenSim/MatchData/Breakdown");
    ...
    public static BooleanPublisher resetFieldPublisher = NetworkTableInstance.getDefault()
            .getTable("SmartDashboard/RenSim/MatchData")
    ...
    public static SimulatedArena getInstance() {
        if (RobotBase.isReal() && (!ALLOW_CREATION_ON_REAL_ROBOT))
            throw new IllegalStateException(
                    "RenSim is running on a real robot! (If you would actually want that, set SimulatedArena.ALLOW_CREATION_ON_REAL_ROBOT to true).");

        if (instance == null) instance = new org.ruthiefrc.rensim.simulation.seasonspecific.rebuilt2026.Arena2026Rebuilt();
     ...
     * collision space.
     *
     * <p>This method immediately starts the {@link org.ruthiefrc.rensim.simulation.IntakeSimulation.GamePieceContactListener},
     ...
     *   <li>For example, {@link org.ruthiefrc.rensim.simulation.seasonspecific.crescendo2024.CrescendoNoteOnField} has the
     *       type "Note".
     * </ul>
     *
