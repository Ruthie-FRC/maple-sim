package org.ruthiefrc.rensim.simulation.drivesims;
...
import org.ruthiefrc.rensim.simulation.SimulatedArena;
import org.ruthiefrc.rensim.utils.mathutils.RenCommonMath;
...
public class GyroSimulation {
     ...
     *
     * <p>If you are using this class outside of {@link org.ruthiefrc.rensim.simulation.SimulatedArena}: make sure to call it 5
     * times in each robot period (if using default timings), or refer to
     * {@link org.ruthiefrc.rensim.simulation.SimulatedArena#overrideSimulationTimings(Time, int)}.
     *
    ...
    private Rotation2d getGyroDTheta(double actualAngularVelocityRadPerSec) {
        this.measuredAngularVelocityRadPerSec = RenCommonMath.generateRandomNormal(
        ...
        final double
                AVERAGE_DRIFTING_1_PERIOD =
                        this.AVERAGE_DRIFTING_IN_30_SECS_MOTIONLESS_DEG
                                / 30
                                * SimulatedArena.getSimulationDt().in(Seconds),
                driftingInThisPeriod = RenCommonMath.generateRandomNormal(0, AVERAGE_DRIFTING_1_PERIOD);
