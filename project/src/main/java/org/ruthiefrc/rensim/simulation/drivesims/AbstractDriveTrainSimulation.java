 ...
 */
public abstract class AbstractDriveTrainSimulation extends RigidBody {
     ...
     * {@link org.ruthiefrc.rensim.simulation.SimulatedArena} for instructions on how to add it to the simulation world.
     *
    ...
    protected AbstractDriveTrainSimulation(DriveTrainSimulationConfig config, Pose2d initialPoseOnField) {
        ...
        super.addFixture(
                Geometry2d.createRectangle(WIDTH_IN_WORLD_REFERENCE, HEIGHT_IN_WORLD_REFERENCE),
