...
import org.ruthiefrc.rensim.simulation.motorsims.*;
...
public class SwerveModuleSimulation {
    ...
    private final RenMotorSim steerMotorSim;
    ...
    public SwerveModuleSimulation(SwerveModuleSimulationConfig config) {
        ...
        this.steerMotorSim = new RenMotorSim(config.steerMotorConfigs);
     ...
     * @return the propelling force generated by the module, as a {@link Vec2} object
     */
    public Vec2 updateSimulationSubTickGetModuleForce(
            Vec2 moduleCurrentGroundVelocityWorldRelative,
     ...
     */
    private Vec2 getPropellingForce(
            double grippingForceNewtons, Rotation2d moduleWorldFacing, Vec2 moduleCurrentGroundVelocity) {
        ...
        final double floorVelocityProjectionOnWheelDirectionMPS = moduleCurrentGroundVelocity.getMagnitude()
                * Math.cos(moduleCurrentGroundVelocity.getAngleBetween(new Vec2(moduleWorldFacing.getRadians())));
        ...
        return Vec2.create(propellingForceNewtons, moduleWorldFacing.getRadians());
    }
     ...
     * @see RenMotorSim#getAppliedVoltage()
     */
     ...
     * @see RenMotorSim#getSupplyCurrent()
     */
     ...
     * @see RenMotorSim#getEncoderPosition()
     */
     ...
     * @see RenMotorSim#getEncoderVelocity()
     */
     ...
     * @see RenMotorSim#getAngularPosition()
     */
